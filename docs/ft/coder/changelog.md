...
- **Docs**: **[post-workflow-github-pr-elicitation.md](post-workflow-github-pr-elicitation.md)**; **[workflow-json-schemas.md](workflow-json-schemas.md)**; cross-package **[docs/dev/changesets.md](../../dev/changesets.md)**; dev WIP **[2026-05-02-changeset-post-workflow-pr-elicitation.md](../../dev/1-WIP/2026-05-02-changeset-post-workflow-pr-elicitation.md)**. Package **`changesets.md`** history for **tddy-core**, **tddy-tools**, **tddy-workflow-recipes** defers to this entry per AGENTS.md (`packages/*/docs/` workflow).
