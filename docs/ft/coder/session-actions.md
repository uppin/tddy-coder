...
**Implementation**: [`tddy_workflow_engine::workflow::action_cache`](../../../packages/tddy-workflow-engine/src/workflow/action_cache.rs) (also `tddy_core::workflow::action_cache`), **`BackendInvokeTask`** in [`backend_invoke_task.rs`](../../../packages/tddy-workflow-engine/src/workflow/backend_invoke_task.rs). **Architecture**: [`tddy-workflow-engine` architecture — Workflow action cache](../../../packages/tddy-workflow-engine/docs/architecture.md#workflow-action-cache-workflowaction_cache).
...
- **Implementation**: [`tddy_session_store::session_actions`](../../../packages/tddy-session-store/src/session_actions/mod.rs) (re-exported by `tddy_session_actions::session_actions`, which adds `session_dir`; both reachable as `tddy_core::session_actions`), [`tddy_session_actions::session_action_jobs`](../../../packages/tddy-session-actions/src/session_action_jobs/mod.rs), [`tddy_session_actions::session_action_pipeline`](../../../packages/tddy-session-actions/src/session_action_pipeline.rs), **[`tddy-session-actions` architecture — Session actions](../../../packages/tddy-session-actions/docs/architecture.md#session-actions-session_actions)**, **[Session action jobs](../../../packages/tddy-session-actions/docs/architecture.md#session-action-jobs-session_action_jobs)**, **[Session action pipeline](../../../packages/tddy-session-actions/docs/architecture.md#session-action-pipeline-session_action_pipeline)**, **[Workflow action cache](../../../packages/tddy-workflow-engine/docs/architecture.md#workflow-action-cache-workflowaction_cache)**; **`tddy_tools::session_actions_cli`** (binary wiring)
