# Initial Discovery: Index daemon live plans

**Changeset**: [2026-09-26-index-daemon-live-plans.md](./2026-09-26-index-daemon-live-plans.md)
**Date**: 2026-09-26
...
1. Read `tddy-index-daemon/src/tree_changes.rs` (file change detection for `didChangeWatchedFiles`)
2. Read todo `2026-09-24-restructure-snapshot-cannot-rebase-a-stale-plan.md` (six stale #524 plans; difflib re-anchor script; proposed `snapshot --rebase`)
3. Read `plan.rs::rehashed_header` (what `restructure snapshot` writes today)
