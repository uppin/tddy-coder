# Initial Discovery: the session-agent and activity services

**Changeset**: [2026-09-09-unbundle-session-agent-services.md](./2026-09-09-unbundle-session-agent-services.md)
**Stack**: `#unbundle` node 7 of 8. Explorations 1–6 are the whole-stack discovery, copied here in full as this node's record
**Date**: 2026-09-09
**Passes**: 6
