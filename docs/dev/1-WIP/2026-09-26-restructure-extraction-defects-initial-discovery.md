# Initial Discovery: Extraction defects

**Changeset**: [2026-09-26-restructure-extraction-defects.md](./2026-09-26-restructure-extraction-defects.md)
**Date**: 2026-09-26
...
1. Read todo `2026-09-25-restructure-extract-variable-waits-forever-on-a-range-opening-with-a-borrow.md` — probe at hover-bearing token; bound the wait
2. Read todo `2026-09-25-restructure-extract-variable-hoists-a-borrowed-field-by-value.md` — widen to `&place`; else refuse unusable
3. Read todo `2026-09-25-restructure-extract-method-accepts-a-return-before-a-unit-if-tail.md` — refuse `()` tail; red fixture given
4. Read todo `2026-09-25-restructure-extract-method-leaves-a-function-local-use-behind.md` — import pass over the new function
5. Read `ls packages/tddy-code-restructuring/src/backends/rust` — chatter, documents, early_return, impl_seam, imports, introduced, nested_modules, readiness
