# Initial Discovery: Check/apply parity for cross-crate moves

**Changeset**: [2026-09-26-restructure-check-parity.md](./2026-09-26-restructure-check-parity.md)
**Date**: 2026-09-26
...
1. Read todo `2026-09-25-restructure-check-misses-a-body-path-to-a-module-staying-behind.md` — stays-behind reads headers only; `workspace_session.rs` body paths to `crate::connection_service`
2. Read todo `2026-09-25-restructure-check-misses-a-module-name-the-destination-already-has.md` — static finding; a merge
3. Read todo `2026-09-18-extract-module-cannot-see-sibling-seams-in-one-plan.md` — related parity class, left open
