# Initial Discovery: model registry, telegram and screen sharing in their own crates

**Changeset**: [2026-09-09-unbundle-model-telegram-screen.md](./2026-09-09-unbundle-model-telegram-screen.md)
**Stack**: `#unbundle` node 2 of 8. Explorations 1–6 are the whole-stack discovery, copied here in full as this node's record
**Date**: 2026-09-09
**Passes**: 6
