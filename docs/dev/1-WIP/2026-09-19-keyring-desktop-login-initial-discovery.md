# Initial discovery — `#keyring` 2/9 `desktop-login`

**Node**: `#keyring` 2/9 — desktop-login · branch `feature/keyring/desktop-login` · base `feature/keyring/signing-key (#508)`
**Changeset**: [2026-09-19-keyring-desktop-login.md](./2026-09-19-keyring-desktop-login.md)
