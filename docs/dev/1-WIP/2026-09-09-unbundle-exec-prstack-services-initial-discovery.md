# Initial Discovery: the catalogue, exec-tool and PR-stack services

**Changeset**: [2026-09-09-unbundle-exec-prstack-services.md](./2026-09-09-unbundle-exec-prstack-services.md)
**Stack**: `#unbundle` node 8 of 8. Explorations 1–6 are the whole-stack discovery, copied here in full as this node's record
**Date**: 2026-09-09
**Passes**: 6
