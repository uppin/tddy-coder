# Initial Discovery: the sandbox, spawn and leaf RPC subsystems in their own crates

**Changeset**: [2026-09-09-unbundle-sandbox-spawn-services.md](./2026-09-09-unbundle-sandbox-spawn-services.md)
**Stack**: `#unbundle` node 3 of 8. Explorations 1–6 are the whole-stack discovery, copied here in full as this node's record
**Date**: 2026-09-09
**Passes**: 6
