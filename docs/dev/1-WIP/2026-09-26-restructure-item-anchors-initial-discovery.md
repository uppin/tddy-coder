# Initial Discovery: Restructure item anchors

**Changeset**: [2026-09-26-restructure-item-anchors.md](./2026-09-26-restructure-item-anchors.md)
**Date**: 2026-09-26
...
1. Read plan.rs anchor kinds and header
2. Read backends/rust.rs `anchor_range`, `locate_symbol`, `find_symbol`, `places_of`
3. Read code issue `broken-restructure-anchors-empty-outline.md`
4. Read todo `2026-09-24-restructure-snapshot-cannot-rebase-a-stale-plan.md`
5. Read `.agents/skills/code-restructuring/SKILL.md` and `references/plan-schema.md` (anchor authoring; "Do not hand-write line numbers"; "The plan is a command log and is never rewritten")
6. Read `docs/ft/coder/1-OVERVIEW.md` Active PRDs; `docs/ft/coder/1-WIP/PRD-2026-09-17-restructure-refusal-truth-and-authoring-gates.md` (older WIP; code landed in #502 per `git log`)
