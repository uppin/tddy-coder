# Initial Discovery: cross-crate moves, the daemon kernel, and the host/worktree services

**Changeset**: [2026-09-09-unbundle-host-worktree-services.md](./2026-09-09-unbundle-host-worktree-services.md)
**Stack**: `#unbundle` node 1 of 8. Explorations 1–6 are the whole-stack discovery, copied here in full as this node's Exploration 1–6 record
**Date**: 2026-09-09
**Passes**: 6
