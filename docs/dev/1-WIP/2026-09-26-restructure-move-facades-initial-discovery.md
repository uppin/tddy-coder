# Initial Discovery: Cross-crate move facades

**Changeset**: [2026-09-26-restructure-move-facades.md](./2026-09-26-restructure-move-facades.md)
**Date**: 2026-09-26
...
1. Read todo `2026-09-25-restructure-move-to-crate-leaves-a-nested-modules-parent-glob-dangling.md` — rewrite parent `use <module>::*;` to destination path
2. Read todo `2026-09-25-restructure-move-to-crate-skips-the-use-lines-of-the-moved-files-test-module.md` — walk every `use` at any depth; keep inside `super::`
3. Read todo `2026-09-25-restructure-test-binary-move-cannot-see-through-a-glob-facade.md` — `defining_module_in_crate` treat crate-root glob as candidate
4. Read todo `2026-09-25-restructure-glob-facade-re-exports-a-name-the-origin-shadows.md` — grouped named facade per plan
5. Read todo `2026-09-18-cross-crate-move-cosmetic-facade-and-mod-ordering.md` — `facade_line` per op; `after_last_module_declaration` in `manifest_edits.rs`
