# Initial Discovery: the terminal, context and session-file services

**Changeset**: [2026-09-09-unbundle-session-io-services.md](./2026-09-09-unbundle-session-io-services.md)
**Stack**: `#unbundle` node 6 of 8. Explorations 1–6 are the whole-stack discovery, copied here in full as this node's record
**Date**: 2026-09-09
**Passes**: 6
