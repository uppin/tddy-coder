# Initial Discovery: `tddy-tools` becomes CLI dispatch and an MCP router

**Changeset**: [2026-09-09-unbundle-tools-thinning.md](./2026-09-09-unbundle-tools-thinning.md)
**Stack**: `#unbundle` node 5 of 8. Explorations 1–6 are the whole-stack discovery, copied here in full as this node's record
**Date**: 2026-09-09
**Passes**: 6
