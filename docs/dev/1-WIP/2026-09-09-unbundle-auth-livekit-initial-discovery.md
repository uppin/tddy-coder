# Initial Discovery: the auth and LiveKit subsystems in their own crates

**Changeset**: [2026-09-09-unbundle-auth-livekit.md](./2026-09-09-unbundle-auth-livekit.md)
**Stack**: `#unbundle` node 4 of 8. Explorations 1–6 are the whole-stack discovery, copied here in full as this node's record
**Date**: 2026-09-09
**Passes**: 6
