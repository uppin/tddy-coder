...
#
# Layout in the .deb:
#   /usr/bin/{tddy-daemon,tddy-coder,tddy-tools,codex-acp}
#   /usr/share/tddy/web/...
...
for f in target/release/tddy-daemon target/release/tddy-coder target/release/tddy-tools; do
...
Description: tddy — TDD-driven coder daemon, CLI, tools, and web dashboard
 Bundles tddy-daemon, tddy-coder, tddy-tools, and codex-acp,
