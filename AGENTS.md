...
| `./release` | Build optimized production binaries (`tddy-coder`, `tddy-tools`, `tddy-daemon`, `tddy-supervisor`, `tddy-remote-git-repo`, `tddy-session-sync`, `tddy-sandbox-runner`, `tddy-index-daemon`). Output: `target/release/...`. |
