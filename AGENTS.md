...
| Release | `./release` — optimized production build (output: `target/release/tddy-coder`, `target/release/tddy-tools`, `target/release/tddy-daemon`, `target/release/tddy-supervisor`) |
