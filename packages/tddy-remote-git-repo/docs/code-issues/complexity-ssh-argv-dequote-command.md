# complexity: dequote_command

**Location:** `packages/tddy-remote-git-repo/src/ssh_argv.rs:154` — `dequote_command`
**Category:** complexity
**Detected:** 2026-09-18 — targeted by `/jev-restructuring` sweep, measured by structural scan
**Metrics:** **47 lines** · **nesting depth 6** · 1 parameters · 5 branch/match lines · 0 early exits
...
|---|---|---|---|---|---|
| 2026-09-18 | 47 | 6 | 5 | 0 | first detection |
...
The function carries **5 branch or match lines** and **0 early exits**
(`return` / `?`). Its file is 206 lines total, 206 of them production, with **no `#[cfg(test)]` block**, across 3 functions.

**How this was found.** `/jev-restructuring` ranked it 26 of 3,503 production units by
