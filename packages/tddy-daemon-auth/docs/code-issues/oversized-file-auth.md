...
**Metrics:** **619 production lines** (2026-09-24, HEAD of #510; 576 on `origin/master` `35cf2913`), counted to the first `#[cfg(test)]` · budget 500 · ~1.24× over · 1,400 lines in all
**Thresholds breached:** length 619 > 500
...
**Status:** Open. Split deferred with the developer's consent during #510's wrap, to a follow-up after the `#keyring` stack lands — `docs/dev/todo/2026-09-24-keyring-store-deferred-auth-and-attach-splits.md`
