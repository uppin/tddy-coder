...
**Metrics:** **622 production lines** (2026-09-24, HEAD of #510; 576 on `origin/master` `35cf2913`), counted to the first `#[cfg(test)]` · budget 500 · ~1.24× over · 1,403 lines in all
