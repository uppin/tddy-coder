# complexity: build_auth_entries

**Location:** `packages/tddy-daemon-auth/src/auth.rs:51` — `build_auth_entries`
**Category:** complexity
**Detected:** 2026-09-18 — targeted by `/jev-restructuring` sweep, measured by structural scan
**Metrics:** **104 lines** · **nesting depth 4** · 3 parameters · 6 branch/match lines · 3 early exits
**Thresholds breached:** length 104 > 60 (`/analyze-clean-code`)
...
|---|---|---|---|---|---|
| 2026-09-18 | 104 | 4 | 6 | 3 | first detection |

## What the tool found

The body is **104 lines**, 1.7x the 60-line ceiling at which `/analyze-clean-code` says a function must be refactored.

The function carries **6 branch or match lines** and **3 early exits**
(`return` / `?`). Its file is 1200 lines total, 470 of them production, across 5 functions.
...
Bring it under the `/analyze-clean-code` thresholds — length 104 > 60 — by `extract_method`
