...
**Location:** `packages/tddy-daemon-auth/src/auth.rs:167` — `build_auth_entries_admitting`
...
**Metrics:** **106 lines** (2026-09-24; 92 before #509, 104 at detection) · **nesting depth 4** · 5 parameters (at the budget, not over) · 5 branch/match lines · 3 early exits
**Thresholds breached:** length 106 > 60 (`/analyze-clean-code`)
**Restructure:** `extract_method` — `/code-restructuring` territory
**Status:** Open — regressed 2026-09-24 (92 → 106 lines in #509, `#keyring` 2/9; 104 at detection) — **unclaimed**
