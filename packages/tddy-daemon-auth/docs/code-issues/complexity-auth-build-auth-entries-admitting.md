...
**Metrics:** **109 lines** (2026-09-24, #510 after its idle-vault follow-up; 110 at #510's wrap; 106 before #510, 92 before #509, 104 at detection) · **nesting depth 4** · 5 parameters (at the budget, not over) · 5 branch/match lines · 3 early exits
...
| 2026-09-24 | 109 | 4 | 5 | 3 | 110 at #510's wrap (`0918ff8c`) → 109 after its post-wrap follow-up: `vault_lifetimes::credential_vaults_in(dir, github)` takes the whole `github:` block (it now reads two lifetimes from it), so the `let ttl` line went (−1). Branches, exits and nesting unchanged |
