...
**Location:** `packages/tddy-task/src/terminal_capture.rs:352` — `feed`
**Category:** complexity
**Detected:** 2026-09-18 — targeted by `/jev-restructuring` sweep, measured by structural scan
**Metrics:** **54 lines** · **nesting depth 5** · 1 parameters · 9 branch/match lines · 1 early exits
...
|---|---|---|---|---|---|
| 2026-09-18 | 54 | 5 | 9 | 1 | first detection |
...
The function carries **9 branch or match lines** and **1 early exits**
(`return` / `?`). Its file is 482 lines total, 482 of them production, with **no `#[cfg(test)]` block**, across 19 functions.

**How this was found.** `/jev-restructuring` ranked it 39 of 3,503 production units by
