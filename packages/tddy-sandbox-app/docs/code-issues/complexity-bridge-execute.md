...
**Location:** `packages/tddy-sandbox-app/src/bridge.rs:90` — `execute`
**Category:** complexity
**Detected:** 2026-09-18 — targeted by `/jev-restructuring` sweep, measured by structural scan
**Metrics:** **54 lines** · **nesting depth 5** · 3 parameters · 4 branch/match lines · 3 early exits
...
|---|---|---|---|---|---|
| 2026-09-18 | 54 | 5 | 4 | 3 | first detection |
...
The function carries **4 branch or match lines** and **3 early exits**
(`return` / `?`). Its file is 578 lines total, 406 of them production, across 6 functions.

**How this was found.** `/jev-restructuring` ranked it 99 of 3,503 production units by
