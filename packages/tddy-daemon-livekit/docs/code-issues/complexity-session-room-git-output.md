# complexity: git_output

**Location:** `packages/tddy-daemon-livekit/src/session_room.rs:1144` — `git_output`
**Category:** complexity
**Detected:** 2026-09-18 — targeted by `/jev-restructuring` sweep, measured by structural scan
**Metrics:** **84 lines** · **nesting depth 3** · 4 parameters · 6 branch/match lines · 3 early exits
**Thresholds breached:** length 84 > 60 (`/analyze-clean-code`)
...
|---|---|---|---|---|---|
| 2026-09-18 | 84 | 3 | 6 | 3 | first detection |

## What the tool found

The body is **84 lines**, 1.4x the 60-line ceiling at which `/analyze-clean-code` says a function must be refactored.
...
**How this was found.** `/jev-restructuring` ranked it 52 of 3,503 production units by
...
Bring it under the `/analyze-clean-code` thresholds — length 84 > 60 — by `extract_method`
