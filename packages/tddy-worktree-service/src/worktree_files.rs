...
pub fn canonicalize_root(worktree_root: &Path) -> Result<PathBuf, Status> {
...
pub fn validate_rel_path_shape(rel_path: &str) -> Result<String, Status> {
...
/// separated.
pub fn git_listed_files(worktree_root: &Path) -> Result<Vec<String>, Status> {
