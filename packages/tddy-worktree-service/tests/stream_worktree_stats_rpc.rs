...
use tddy_worktree_service::test_util::TEST_TOKEN;
use tddy_worktree_service::worktrees::WorktreeSizeCalculator;
...
/// `calc_root`.
fn test_service(sessions_base: PathBuf, os_user: &str, calc_root: PathBuf) -> WorktreeServiceImpl {
    ...
    WorktreeServiceImpl::new(config, tddy_data_dir, user_resolver)
