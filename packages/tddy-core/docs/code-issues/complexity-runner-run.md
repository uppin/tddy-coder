...
**Location:** `packages/tddy-core/src/workflow/runner.rs:41` — `run`
**Category:** complexity
**Detected:** 2026-09-18 — targeted by `/jev-restructuring` sweep, measured by structural scan
**Metrics:** **122 lines** · **nesting depth 7** · 1 parameters · 8 branch/match lines · 14 early exits
**Thresholds breached:** length 122 > 60; nesting 7 > 4 (`/analyze-clean-code`)
...
|---|---|---|---|---|---|
| 2026-09-18 | 122 | 7 | 8 | 14 | first detection |

## What the tool found

The body is **122 lines**, 2.0x the 60-line ceiling at which `/analyze-clean-code` says a function must be refactored.

The function carries **8 branch or match lines** and **14 early exits**
(`return` / `?`). Its file is 163 lines total, 163 of them production, with **no `#[cfg(test)]` block**, across 3 functions.

**How this was found.** `/jev-restructuring` ranked it 19 of 3,503 production units by
...
Bring it under the `/analyze-clean-code` thresholds — length 122 > 60; nesting 7 > 4 — by `extract_method`
