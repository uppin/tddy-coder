...
**Location:** `packages/tddy-core/src/workflow/task.rs:224` — `run`
**Category:** complexity
**Detected:** 2026-09-18 — targeted by `/jev-restructuring` sweep, measured by structural scan
**Metrics:** **271 lines** · **nesting depth 6** · 1 parameters · 23 branch/match lines · 7 early exits
**Thresholds breached:** length 271 > 60; nesting 6 > 4 (`/analyze-clean-code`)
...
|---|---|---|---|---|---|
| 2026-09-18 | 271 | 6 | 23 | 7 | first detection |

## What the tool found

The body is **271 lines**, 4.5x the 60-line ceiling at which `/analyze-clean-code` says a function must be refactored.

The function carries **23 branch or match lines** and **7 early exits**
(`return` / `?`). Its file is 495 lines total, 495 of them production, with **no `#[cfg(test)]` block**, across 16 functions.

**How this was found.** `/jev-restructuring` ranked it 54 of 3,503 production units by
...
Bring it under the `/analyze-clean-code` thresholds — length 271 > 60; nesting 6 > 4 — by `extract_method`
