...
**Location:** `packages/tddy-core/src/presenter/presenter_impl.rs:620` — `handle_intent`
**Category:** complexity
...
Bring it under the `/analyze-clean-code` thresholds — length 379 > 60; nesting 8 > 4 — by `extract_method`
