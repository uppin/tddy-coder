# complexity: stream_acp_replay

**Location:** `packages/tddy-session-activity/src/service.rs:682` — `stream_acp_replay`
**Category:** complexity
**Detected:** 2026-09-18 — targeted by `/jev-restructuring` sweep, measured by structural scan
**Metrics:** **80 lines** · **nesting depth 3** · 1 parameters · 5 branch/match lines · 4 early exits
...
|---|---|---|---|---|---|
| 2026-09-18 | 80 | 3 | 5 | 4 | first detection |
...
(`return` / `?`). Its file is 819 lines total, 819 of them production, with **no `#[cfg(test)]` block**, across 17 functions.

**How this was found.** `/jev-restructuring` ranked it 61 of 3,503 production units by
