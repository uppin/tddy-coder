//! Acceptance tests for TerminalService StreamTerminalIO RPC.
//!
//! Run with: cargo test -p tddy-livekit --test terminal_service_acceptance
//! Requires: LIVEKIT_TESTKIT_WS_URL (from ./run-livekit-testkit-server)
//!
//! Uses #[serial] to avoid parallel execution with rpc_scenarios (both use LiveKitTestkit).
...
use tddy_livekit::proto::terminal::{TerminalInput, TerminalOutput};
use tddy_livekit::{LiveKitParticipant, RpcClient, TerminalServiceImpl};
