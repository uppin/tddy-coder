# complexity: handle_telegram_branch_callback

**Location:** `packages/tddy-telegram-control/src/telegram_session_control/pickers.rs:220` — `handle_telegram_branch_callback`
...
**Metrics:** **177 lines** · **nesting depth 4** · 5 parameters · 20 branch/match lines · 19 early exits
**CRAP:** **CRAP 1806** · complexity 42 · rank 4/50 in this crate · **never executed by any test**
**Thresholds breached:** length 177 > 60 (`/analyze-clean-code`)
...
|---|---|---|---|---|---|
| 2026-09-18 | 177 | 4 | 20 | 19 | first detection |

## What the tool found

The body is **177 lines**, 3.0x the 60-line ceiling at which `/analyze-clean-code` says a function must be refactored.

The function carries **20 branch or match lines** and **19 early exits**
(`return` / `?`). Its file is 4476 lines total, 3981 of them production, across 70 functions.

**How this was found.** `/jev-restructuring` ranked it 45 of 3,503 production units by
...
Bring it under the `/analyze-clean-code` thresholds — length 177 > 60 — by `extract_method`
