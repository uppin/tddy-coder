# complexity: run_call_tool

**Location:** `packages/tddy-tools/src/cli.rs:525` — `run_call_tool`
**Category:** complexity
**Detected:** 2026-09-18 — targeted by `/jev-restructuring` sweep, measured by structural scan
**Metrics:** **93 lines** · **nesting depth 4** · 1 parameters · 11 branch/match lines · 3 early exits
**Thresholds breached:** length 93 > 60 (`/analyze-clean-code`)
...
|---|---|---|---|---|---|
| 2026-09-18 | 93 | 4 | 11 | 3 | first detection |

## What the tool found

The body is **93 lines**, 1.6x the 60-line ceiling at which `/analyze-clean-code` says a function must be refactored.

The function carries **11 branch or match lines** and **3 early exits**
(`return` / `?`). Its file is 910 lines total, 896 of them production, across 15 functions.

**How this was found.** `/jev-restructuring` ranked it 87 of 3,503 production units by
...
Bring it under the `/analyze-clean-code` thresholds — length 93 > 60 — by `extract_method`
