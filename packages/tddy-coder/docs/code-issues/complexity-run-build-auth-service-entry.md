# complexity: build_auth_service_entry

**Location:** `packages/tddy-coder/src/run.rs:1131` — `build_auth_service_entry`
**Category:** complexity
**Detected:** 2026-09-18 — targeted by `/jev-restructuring` sweep, measured by structural scan
**Metrics:** **65 lines** · **nesting depth 6** · 1 parameters · 8 branch/match lines · 0 early exits
**Thresholds breached:** length 65 > 60; nesting 6 > 4 (`/analyze-clean-code`)
...
**How this was found.** `/jev-restructuring` ranked it 100 of 3,503 production units by
...
Bring it under the `/analyze-clean-code` thresholds — length 65 > 60; nesting 6 > 4 — by `extract_method`
