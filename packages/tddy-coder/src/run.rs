...
pub struct Args {
    ...
    /// Workflow recipe name (`tdd`, `bugfix`, `free-prompting`, or `grill-me`). `None` means default `free-prompting` or recipe from changeset on resume.
...
pub struct CoderArgs {
    ...
    /// Workflow recipe: `free-prompting` (default when omitted), `tdd`, `bugfix`, or `grill-me`. Must match [`WorkflowRecipe::name`].
    #[arg(long, value_parser = ["tdd", "tdd-small", "bugfix", "free-prompting", "grill-me"])]
    pub recipe: Option<String>,
...
pub struct DemoArgs {
    ...
    /// Workflow recipe: `free-prompting` (default when omitted), `tdd`, `bugfix`, or `grill-me`.
    #[arg(long, value_parser = ["tdd", "tdd-small", "bugfix", "free-prompting", "grill-me"])]
    pub recipe: Option<String>,
}
