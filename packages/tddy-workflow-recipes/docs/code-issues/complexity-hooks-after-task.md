# complexity: after_task

**Location:** `packages/tddy-workflow-recipes/src/tdd_small/hooks.rs:565` — `after_task`
**Category:** complexity
**Detected:** 2026-09-18 — targeted by `/jev-restructuring` sweep, measured by structural scan
**Metrics:** **79 lines** · **nesting depth 5** · 3 parameters · 8 branch/match lines · 9 early exits
**Thresholds breached:** length 79 > 60; nesting 5 > 4 (`/analyze-clean-code`)
...
|---|---|---|---|---|---|
| 2026-09-18 | 79 | 5 | 8 | 9 | first detection |

## What the tool found

The body is **79 lines**, 1.3x the 60-line ceiling at which `/analyze-clean-code` says a function must be refactored.

The function carries **8 branch or match lines** and **9 early exits**
(`return` / `?`). Its file is 697 lines total, 697 of them production, with **no `#[cfg(test)]` block**, across 20 functions.

**How this was found.** `/jev-restructuring` ranked it 95 of 3,503 production units by
...
Bring it under the `/analyze-clean-code` thresholds — length 79 > 60; nesting 5 > 4 — by `extract_method`
