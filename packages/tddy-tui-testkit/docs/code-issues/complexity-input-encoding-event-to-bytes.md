# complexity: event_to_bytes

**Location:** `packages/tddy-tui-testkit/src/input_encoding.rs:18` — `event_to_bytes`
**Category:** complexity
**Detected:** 2026-09-18 — targeted by `/jev-restructuring` sweep, measured by structural scan
**Metrics:** **49 lines** · **nesting depth 5** · 1 parameters · 7 branch/match lines · 3 early exits
...
|---|---|---|---|---|---|
| 2026-09-18 | 49 | 5 | 7 | 3 | first detection |
...
(`return` / `?`). Its file is 66 lines total, 66 of them production, with **no `#[cfg(test)]` block**, across 0 functions.

**How this was found.** `/jev-restructuring` ranked it 64 of 3,503 production units by
