...
**Location:** `packages/tddy-graph/src/runner.rs:39` — `run`
**Category:** complexity
**Detected:** 2026-09-18 — targeted by `/jev-restructuring` sweep, measured by structural scan
**Metrics:** **116 lines** · **nesting depth 7** · 1 parameters · 9 branch/match lines · 14 early exits
**Thresholds breached:** length 116 > 60; nesting 7 > 4 (`/analyze-clean-code`)
...
|---|---|---|---|---|---|
| 2026-09-18 | 116 | 7 | 9 | 14 | first detection |

## What the tool found

The body is **116 lines**, 1.9x the 60-line ceiling at which `/analyze-clean-code` says a function must be refactored.

The function carries **9 branch or match lines** and **14 early exits**
(`return` / `?`). Its file is 492 lines total, 157 of them production, across 3 functions.

**How this was found.** `/jev-restructuring` ranked it 22 of 3,503 production units by
...
Bring it under the `/analyze-clean-code` thresholds — length 116 > 60; nesting 7 > 4 — by `extract_method`
