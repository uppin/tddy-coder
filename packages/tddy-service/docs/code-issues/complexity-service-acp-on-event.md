...
**Location:** `packages/tddy-service/src/service_acp.rs:81` — `on_event`
**Category:** complexity
**Detected:** 2026-09-18 — targeted by `/jev-restructuring` sweep, measured by structural scan
**Metrics:** **41 lines** · **nesting depth 5** · 2 parameters · 5 branch/match lines · 0 early exits
...
|---|---|---|---|---|---|
| 2026-09-18 | 41 | 5 | 5 | 0 | first detection |
...
(`return` / `?`). Its file is 464 lines total, 341 of them production, across 11 functions.

**How this was found.** `/jev-restructuring` ranked it 58 of 3,503 production units by
