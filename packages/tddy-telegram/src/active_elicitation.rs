...
//!
//! Outbound `tddy_telegram_control::telegram_notifier::TelegramSessionWatcher` and inbound
//! `tddy_telegram_control::telegram_session_control::TelegramSessionControlHarness` share one
...
impl ActiveElicitationCoordinator {
    ...
    ///
    /// Used when `tddy_telegram_control::telegram_notifier::TelegramSessionWatcher` observes `was_eliciting &&
