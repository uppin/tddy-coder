# complexity: serve_stream

**Location:** `packages/tddy-model-registry/src/acp_service.rs:139` — `serve_stream`
**Category:** complexity
**Detected:** 2026-09-18 — targeted by `/jev-restructuring` sweep, measured by structural scan
**Metrics:** **119 lines** · **nesting depth 7** · 3 parameters · 7 branch/match lines · 3 early exits
**Thresholds breached:** length 119 > 60; nesting 7 > 4 (`/analyze-clean-code`)
...
|---|---|---|---|---|---|
| 2026-09-18 | 119 | 7 | 7 | 3 | first detection |

## What the tool found

The body is **119 lines**, 2.0x the 60-line ceiling at which `/analyze-clean-code` says a function must be refactored.

The function carries **7 branch or match lines** and **3 early exits**
(`return` / `?`). Its file is 657 lines total, 657 of them production, with **no `#[cfg(test)]` block**, across 11 functions.

**How this was found.** `/jev-restructuring` ranked it 18 of 3,503 production units by
...
Bring it under the `/analyze-clean-code` thresholds — length 119 > 60; nesting 7 > 4 — by `extract_method`
