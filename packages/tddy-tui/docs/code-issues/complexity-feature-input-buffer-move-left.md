# complexity: move_left

**Location:** `packages/tddy-tui/src/feature_input_buffer.rs:295` — `move_left`
**Category:** complexity
**Detected:** 2026-09-18 — targeted by `/jev-restructuring` sweep, measured by structural scan
**Metrics:** **45 lines** · **nesting depth 6** · 0 parameters · 9 branch/match lines · 5 early exits
...
|---|---|---|---|---|---|
| 2026-09-18 | 45 | 6 | 9 | 5 | first detection |
...
The function carries **9 branch or match lines** and **5 early exits**
(`return` / `?`). Its file is 537 lines total, 453 of them production, across 20 functions.

**How this was found.** `/jev-restructuring` ranked it 14 of 3,503 production units by
