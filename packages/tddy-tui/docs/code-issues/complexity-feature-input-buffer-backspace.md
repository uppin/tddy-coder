# complexity: backspace

**Location:** `packages/tddy-tui/src/feature_input_buffer.rs:241` — `backspace`
**Category:** complexity
**Detected:** 2026-09-18 — targeted by `/jev-restructuring` sweep, measured by structural scan
**Metrics:** **53 lines** · **nesting depth 7** · 0 parameters · 8 branch/match lines · 5 early exits
...
|---|---|---|---|---|---|
| 2026-09-18 | 53 | 7 | 8 | 5 | first detection |
...
The function carries **8 branch or match lines** and **5 early exits**
(`return` / `?`). Its file is 537 lines total, 453 of them production, across 20 functions.

**How this was found.** `/jev-restructuring` ranked it 17 of 3,503 production units by
