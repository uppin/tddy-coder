# complexity: insert_char

**Location:** `packages/tddy-tui/src/feature_input_buffer.rs:182` — `insert_char`
**Category:** complexity
**Detected:** 2026-09-18 — targeted by `/jev-restructuring` sweep, measured by structural scan
**Metrics:** **58 lines** · **nesting depth 6** · 1 parameters · 10 branch/match lines · 3 early exits
...
|---|---|---|---|---|---|
| 2026-09-18 | 58 | 6 | 10 | 3 | first detection |
...
The function carries **10 branch or match lines** and **3 early exits**
(`return` / `?`). Its file is 537 lines total, 453 of them production, across 20 functions.

**How this was found.** `/jev-restructuring` ranked it 24 of 3,503 production units by
