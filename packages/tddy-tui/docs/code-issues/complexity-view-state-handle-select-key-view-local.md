# complexity: handle_select_key_view_local

**Location:** `packages/tddy-tui/src/view_state.rs:745` — `handle_select_key_view_local`
**Category:** complexity
**Detected:** 2026-09-18 — targeted by `/jev-restructuring` sweep, measured by structural scan
**Metrics:** **78 lines** · **nesting depth 5** · 2 parameters · 10 branch/match lines · 0 early exits
**Thresholds breached:** length 78 > 60; nesting 5 > 4 (`/analyze-clean-code`)
...
|---|---|---|---|---|---|
| 2026-09-18 | 78 | 5 | 10 | 0 | first detection |

## What the tool found

The body is **78 lines**, 1.3x the 60-line ceiling at which `/analyze-clean-code` says a function must be refactored.
...
**How this was found.** `/jev-restructuring` ranked it 44 of 3,503 production units by
...
Bring it under the `/analyze-clean-code` thresholds — length 78 > 60; nesting 5 > 4 — by `extract_method`
