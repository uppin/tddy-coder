# complexity: handle_mouse_event

**Location:** `packages/tddy-tui/src/mouse_map.rs:144` — `handle_mouse_event`
**Category:** complexity
**Detected:** 2026-09-18 — targeted by `/jev-restructuring` sweep, measured by structural scan
**Metrics:** **71 lines** · **nesting depth 6** · 5 parameters · 13 branch/match lines · 9 early exits
**Thresholds breached:** length 71 > 60; nesting 6 > 4 (`/analyze-clean-code`)
...
|---|---|---|---|---|---|
| 2026-09-18 | 71 | 6 | 13 | 9 | first detection |
...
The function carries **13 branch or match lines** and **9 early exits**
(`return` / `?`). Its file is 1042 lines total, 383 of them production, across 4 functions.

**How this was found.** `/jev-restructuring` ranked it 31 of 3,503 production units by
...
Bring it under the `/analyze-clean-code` thresholds — length 71 > 60; nesting 6 > 4 — by `extract_method`
