# complexity: run_event_loop

**Location:** `packages/tddy-tui/src/event_loop.rs:38` — `run_event_loop`
**Category:** complexity
**Detected:** 2026-09-18 — targeted by `/jev-restructuring` sweep, measured by structural scan
**Metrics:** **168 lines** · **nesting depth 7** · 5 parameters · 18 branch/match lines · 10 early exits
**Thresholds breached:** length 168 > 60; nesting 7 > 4 (`/analyze-clean-code`)
...
|---|---|---|---|---|---|
| 2026-09-18 | 168 | 7 | 18 | 10 | first detection |

## What the tool found

The body is **168 lines**, 2.8x the 60-line ceiling at which `/analyze-clean-code` says a function must be refactored. It is the **only function in its file**, so the file's 207 production lines are this function and nothing else — there is nothing else to move out.

The function carries **18 branch or match lines** and **10 early exits**
(`return` / `?`). Its file is 218 lines total, 207 of them production.

**How this was found.** `/jev-restructuring` ranked it 76 of 3,503 production units by
...
Bring it under the `/analyze-clean-code` thresholds — length 168 > 60; nesting 7 > 4 — by `extract_method`
