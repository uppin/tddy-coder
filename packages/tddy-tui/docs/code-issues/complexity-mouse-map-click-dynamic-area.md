# complexity: click_dynamic_area

**Location:** `packages/tddy-tui/src/mouse_map.rs:267` — `click_dynamic_area`
**Category:** complexity
**Detected:** 2026-09-18 — targeted by `/jev-restructuring` sweep, measured by structural scan
**Metrics:** **67 lines** · **nesting depth 4** · 4 parameters · 13 branch/match lines · 6 early exits
**Thresholds breached:** length 67 > 60 (`/analyze-clean-code`)
...
|---|---|---|---|---|---|
| 2026-09-18 | 67 | 4 | 13 | 6 | first detection |

## What the tool found

The body is **67 lines**, 1.1x the 60-line ceiling at which `/analyze-clean-code` says a function must be refactored.

The function carries **13 branch or match lines** and **6 early exits**
(`return` / `?`). Its file is 1042 lines total, 383 of them production, across 4 functions.

**How this was found.** `/jev-restructuring` ranked it 83 of 3,503 production units by
...
Bring it under the `/analyze-clean-code` thresholds — length 67 > 60 — by `extract_method`
