# complexity: move_right

**Location:** `packages/tddy-tui/src/feature_input_buffer.rs:341` — `move_right`
**Category:** complexity
**Detected:** 2026-09-18 — targeted by `/jev-restructuring` sweep, measured by structural scan
**Metrics:** **42 lines** · **nesting depth 6** · 0 parameters · 7 branch/match lines · 4 early exits
...
|---|---|---|---|---|---|
| 2026-09-18 | 42 | 6 | 7 | 4 | first detection |
...
The function carries **7 branch or match lines** and **4 early exits**
(`return` / `?`). Its file is 537 lines total, 453 of them production, across 20 functions.

**How this was found.** `/jev-restructuring` ranked it 38 of 3,503 production units by
