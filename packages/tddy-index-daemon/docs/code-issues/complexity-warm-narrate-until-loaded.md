# complexity: narrate_until_loaded

**Location:** `packages/tddy-index-daemon/src/warm.rs:102` — `narrate_until_loaded`
**Category:** complexity
**Detected:** 2026-09-18 — targeted by `/jev-restructuring` sweep, measured by structural scan
**Metrics:** **44 lines** · **nesting depth 5** · 3 parameters · 6 branch/match lines · 5 early exits
...
|---|---|---|---|---|---|
| 2026-09-18 | 44 | 5 | 6 | 5 | first detection |
...
The function carries **6 branch or match lines** and **5 early exits**
(`return` / `?`). Its file is 282 lines total, 195 of them production, across 0 functions.

**How this was found.** `/jev-restructuring` ranked it 98 of 3,503 production units by
