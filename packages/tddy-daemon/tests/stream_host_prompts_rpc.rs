...
//! tests in `tddy_daemon::host_prompts`, which is where that logic lives. What only an integration
...
use tddy_service::proto::connection::{
    ConnectionService as ConnectionServiceTrait, StreamHostPromptsRequest,
};
