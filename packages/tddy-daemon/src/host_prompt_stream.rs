...
/// Keeps [`ConnectionServiceImpl::pending_prompt_pump_count`] honest for the life of one pump.
///
...
///
/// [`ConnectionServiceImpl::pending_prompt_pump_count`]: crate::connection_service::ConnectionServiceImpl::pending_prompt_pump_count
